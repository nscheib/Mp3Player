...
public class Mp3View extends BorderPane {
    ...
    public Mp3View() {
        ...
        title.getStyleClass().add("color");
        interpret.getStyleClass().add("color2");
        time.getStyleClass().add("color3");
        timeZwei.getStyleClass().add("color4");
